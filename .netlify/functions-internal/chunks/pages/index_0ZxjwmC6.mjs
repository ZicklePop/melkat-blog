...
import {
  ...
  i as createTransitionScope,
  j as renderComponent,
  k as renderSlot,
  l as renderHead,
  u as unescapeHTML,
  A as AstroError,
  n as UnknownContentCollectionError,
  o as renderUniqueStylesheet,
  p as renderScriptElement,
  q as createHeadAndContent,
  F as Fragment,
} from '../astro_5SK3W5mn.mjs'
import 'kleur/colors'
import 'clsx'
/* empty css                           */
import { $ as $$Image } from './generic_BnXrrSbh.mjs'
import { marked } from 'marked'
import { prependForwardSlash } from '@astrojs/internal-helpers/path'
import map from 'lodash/map.js'
import uFuzzy from '@leeoniya/ufuzzy'

const $$Astro$m = createAstro('https://melkat.blog')
const $$ViewTransitions = createComponent(
  ...
  '/Users/melanie/Developer/melkat-blog/node_modules/astro/components/ViewTransitions.astro',
  void 0
)
...
const $$Header = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<header role="banner"${addAttribute(createTransitionScope($$result, 'tpjglai5'), 'data-astro-transition-persist')}> <h1${addAttribute(cx.h1, 'class')}> <a href="/"${addAttribute(cx.link, 'class')}> <div${addAttribute(cx.logo, 'class')} title="emoji by dzuk.zone"> ${renderComponent($$result, 'Logo', $$Logo, { width: 64 })} </div>${title} </a> </h1> </header>`
  },
...
const $$Button = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    Astro2.self = $$Button
    const cx =
      'rounded-lg bg-cerulean-700 motion-reduce:transition-none transition font-bold text-white transition-colors hover:bg-cerulean-600 active:bg-cerulean-800 text-center px-4 py-2 focus:ring-2 outline-none border-2 border-cerulean-700 shadow-lg focus:shadow-md shadow-cerulean-600/20 focus:shadow-cerulean-600/50'
...
const $$Search = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    const cx = {
      ...
      label: 'hidden',
      input:
        'appearance-none motion-reduce:transition-none transition border-0 outline-none placeholder:text-gray-600 dark:placeholder:text-gray-400 bg-transparent ring-2 ring-cerulean-600/50 focus:ring-cerulean-500/75 rounded-lg px-4 py-2 w-full shadow-lg focus:shadow-md shadow-cerulean-500/20 focus:shadow-cerulean-500/50 text-lg',
      p: 'mb-8 italic',
    }
...
const $$Footer = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<footer${addAttribute(cx.footer, 'class')} role="contentinfo"> ${showSearch && renderTemplate`<div${addAttribute(cx.search, 'class')}> ${renderComponent($$result, 'Search', $$Search, {})} </div>`} <p${addAttribute(cx.p, 'class')}> ${'browse by '} <a${addAttribute(cxs.a, 'class')} href="/d">links</a> ${' and '} <a${addAttribute(cxs.a, 'class')} href="/t">tags</a> <br> <a${addAttribute(cxs.a, 'class')} href="/rss.xml">rss feed</a> ${' \u2022 '} <a${addAttribute(cxs.a, 'class')} href="/feed.json">json feed</a> </p> <p${addAttribute(cx.p, 'class')}>
melkat emoji by
<a${addAttribute(cxs.a, 'class')} href="https://dzuk.zone">dzuk</a> </p> <p${addAttribute(cx.p, 'class')}>
a blog by
<a${addAttribute(cxs.a, 'class')} href="https://melaniekat.com" rel="me">melanie kat</a>
&lt;3
</p> </footer>`
  },
...
const $$BaseLayout = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`<html lang="en"> <head><title>${title$1}</title><meta charset="utf-8"><meta name="description"${addAttribute(description$1, 'content')}><meta name="keywords" content="melkat, blog"><meta name="viewport" content="initial-scale=1.0, width=device-width"><meta property="og:description"${addAttribute(description$1, 'content')}><meta property="og:image:height" content="630"><meta property="og:image:width" content="1200"><meta property="og:image"${addAttribute(`${baseUrl}${cover}`, 'content')}><meta property="og:title"${addAttribute(title$1, 'content')}><meta property="og:type" content="website"><meta property="og:url"${addAttribute(`${baseUrl}${permalink}`, 'content')}><link rel="alternate" type="application/feed+json"${addAttribute(title, 'title')} href="/feed.json"><link rel="alternate" type="application/rss+xml"${addAttribute(title, 'title')} href="/rss.xml"><link rel="apple-touch-icon" href="/apple-touch-icon.png"><link rel="canonical"${addAttribute(`${baseUrl}${permalink}`, 'href')}><link rel="icon" href="/favicon.ico"><link rel="mask-icon" sizes="any" href="/mask-icon.svg" color="#0caceb">${renderComponent($$result, 'ViewTransitions', $$ViewTransitions, {})}${renderHead()}</head> <body${addAttribute(className, 'class')}> ${renderComponent($$result, 'Header', $$Header, {})} <main role="main"> ${renderSlot($$result, $$slots['default'])} </main> ${renderComponent($$result, 'Footer', $$Footer, { showSearch: showSearch })} </body></html>`
  },
...
const $$Domain = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<a${addAttribute(cxs.a, 'class')}${addAttribute(`/d/${domain}`, 'href')}${addAttribute(`Posts linking to ${domain}`, 'title')}>${domain} </a>`
  },
...
const $$Cover = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent($$result, 'Image', $$Image, { alt: title, class: cx.img, src: cover, width: 656, height: 369 })}`
  },
...
const $$Permalink = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<a${addAttribute(cxs.a, 'class')}${addAttribute(url, 'href')}${addAttribute(`Permalink for ${title}`, 'title')}><span role="img" aria-label="Star icon">★</span> Permalink
</a>`
  },
...
const $$Tag = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<a${addAttribute(cxs.a, 'class')}${addAttribute(`/t/${tag}`, 'href')}${addAttribute(`Posts tagged #${tag}`, 'aria-label')}>#${tag} </a>`
  },
...
const $$Title = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent($$result, 'PageHeader', $$PageHeader, {}, { default: $$result2 => renderTemplate` ${maybeRenderHead()}<a${addAttribute(link, 'href')}${addAttribute(`${small ? 'text-xl' : 'text-2xl md:text-3xl'} ${isExternal ? cxs.a : cxs.aHover}`, 'class')}${addAttribute(`${isExternal ? 'Link to ' : 'Permalink for '}${title}`, 'title')}${addAttribute({ textWrap: 'balance' }, 'style')}> ${title} </a> ` })}`
  },
...
const $$MiniArticle = createComponent(
  async ($$result, $$props, $$slots) => {
    const Astro2 = $$result.createAstro($$Astro$4, $$props, $$slots)
    Astro2.self = $$MiniArticle
    const { date, title, url } = Astro2.props
    return renderTemplate`${maybeRenderHead()}<div> ${renderComponent($$result, 'Title', $$Title, { title: title, link: url, small: true })} ${renderComponent($$result, 'Details', $$Details, { date: date })} </div>`
  },
  '/Users/melanie/Developer/melkat-blog/src/components/mini-article.astro',
  void 0
)

const $$Astro$3 = createAstro('https://melkat.blog')
const $$RelatedArticles = createComponent(
  async ($$result, $$props, $$slots) => {
    const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots)
    Astro2.self = $$RelatedArticles
    const cx = {
      wrapper: `grid grid-cols-1 md:grid-cols-2 grid-rows-1 gap-4 my-16`,
    }
    const { posts } = Astro2.props
    return renderTemplate`${maybeRenderHead()}<div${addAttribute(cx.wrapper, 'class')}> <h2 class="md:col-span-2 text-xl font-bold">Related posts</h2> ${posts.map(({ data: { date, title }, slug }) => renderTemplate`${renderComponent($$result, 'MiniArticle', $$MiniArticle, { date: date, title: title, url: `/p/${slug}` })}`)} </div>`
  },
  '/Users/melanie/Developer/melkat-blog/src/components/related-articles.astro',
  void 0
)

const $$Astro$2 = createAstro('https://melkat.blog')
const $$TruncatedContent = createComponent(
  async ($$result, $$props, $$slots) => {
    const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots)
    Astro2.self = $$TruncatedContent
    const { content, title, url } = Astro2.props
    const cx = {
      link: 'font-bold hover:underline',
    }
    const truncatedHtml = marked(content)
    return renderTemplate`${maybeRenderHead()}<div>${unescapeHTML(truncatedHtml)}</div> <a${addAttribute(url, 'href')}${addAttribute(cx.link, 'class')}${addAttribute(`Continue reading ${title || 'this post'}`, 'title')}>Continue reading</a>`
  },
  '/Users/melanie/Developer/melkat-blog/src/components/truncated-content.astro',
  void 0
)
...
function truncateMd(md, lines = 5) {
  return md.split('\n#')[0].split('\n').slice(0, lines).join('\n')
}
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({
  '/src/content/posts/134400368.md': () => import('../134400368_AAe4zyLz.mjs'),
  '/src/content/posts/135019114.md': () => import('../135019114_L5dOZK8o.mjs'),
  '/src/content/posts/136222383.md': () => import('../136222383_-9iNfmyk.mjs'),
  '/src/content/posts/136224879.md': () => import('../136224879_rJ0EBPXE.mjs'),
  '/src/content/posts/136224935.md': () => import('../136224935_0V-RJJNV.mjs'),
  '/src/content/posts/136763858.md': () => import('../136763858_aQA9BSnu.mjs'),
  '/src/content/posts/137009001.md': () => import('../137009001_O8TQZ0Ql.mjs'),
  '/src/content/posts/137009091.md': () => import('../137009091_Vnbo7Wn_.mjs'),
  '/src/content/posts/138288124.md': () => import('../138288124_0fP0riiX.mjs'),
  '/src/content/posts/138860938.md': () => import('../138860938_V5BddhwF.mjs'),
  '/src/content/posts/138917375.md': () => import('../138917375_76ek-5Aw.mjs'),
  '/src/content/posts/140113304.md': () => import('../140113304_PZo9Zqy_.mjs'),
  '/src/content/posts/140113399.md': () => import('../140113399_HZWio-HJ.mjs'),
  '/src/content/posts/140113823.md': () => import('../140113823_kcRdmm8h.mjs'),
  '/src/content/posts/140166273.md': () => import('../140166273_OpSYfFvp.mjs'),
  '/src/content/posts/140179091.md': () => import('../140179091_SrNeQEs4.mjs'),
  '/src/content/posts/140733004.md': () => import('../140733004_7dOgO2eo.mjs'),
  '/src/content/posts/141385956.md': () => import('../141385956_zRjf7dmr.mjs'),
  '/src/content/posts/143872419.md': () => import('../143872419_67aMYaiQ.mjs'),
  '/src/content/posts/143963126.md': () => import('../143963126_QrjsoJIE.mjs'),
  '/src/content/posts/145124027.md': () => import('../145124027_oOWPr2rv.mjs'),
  '/src/content/posts/145785077.md': () => import('../145785077_pCO_rlh2.mjs'),
  '/src/content/posts/147888188.md': () => import('../147888188_a2lBz4kJ.mjs'),
  '/src/content/posts/148032540.md': () => import('../148032540_pH5CSjqI.mjs'),
  '/src/content/posts/148553676.md': () => import('../148553676_Ek_0bluc.mjs'),
  '/src/content/posts/148553739.md': () => import('../148553739_xJDLxA4N.mjs'),
  '/src/content/posts/148896468.md': () => import('../148896468_y5TnNZ3K.mjs'),
  '/src/content/posts/151856049.md': () => import('../151856049_2nmp0NpD.mjs'),
  '/src/content/posts/151856082.md': () => import('../151856082_Us7ZVizq.mjs'),
  '/src/content/posts/152139015.md': () => import('../152139015_JL6pu1fM.mjs'),
  '/src/content/posts/152242486.md': () => import('../152242486_GdkDT3bU.mjs'),
  '/src/content/posts/164564932.md': () => import('../164564932_VWsx-J80.mjs'),
  '/src/content/posts/164601922.md': () => import('../164601922_Mng4Dehv.mjs'),
  '/src/content/posts/170712813.md': () => import('../170712813_vA6UrO5s.mjs'),
  '/src/content/posts/170712882.md': () => import('../170712882_Jh3zwhzl.mjs'),
  '/src/content/posts/170716411.md': () => import('../170716411_bSZFNxt_.mjs'),
  '/src/content/posts/173958130.md': () => import('../173958130_LH43N16K.mjs'),
  '/src/content/posts/175577875.md': () => import('../175577875_cZa5x2F2.mjs'),
  '/src/content/posts/175926290.md': () => import('../175926290_hSp9C8KK.mjs'),
  '/src/content/posts/176035092.md': () => import('../176035092_-jOQcTOH.mjs'),
  '/src/content/posts/176243918.md': () => import('../176243918_35xfNLG7.mjs'),
  '/src/content/posts/183883395.md': () => import('../183883395_8EaT3w1n.mjs'),
  '/src/content/posts/183916694.md': () => import('../183916694_ZcEF7lXS.mjs'),
  '/src/content/posts/186172319.md': () => import('../186172319_HO5RLN3E.mjs'),
  '/src/content/posts/187431259.md': () => import('../187431259_SdjSxjJN.mjs'),
  '/src/content/posts/188732962.md': () => import('../188732962_KyjWZ2Wv.mjs'),
  '/src/content/posts/193430221.md': () => import('../193430221_EgUh2AKV.mjs'),
  '/src/content/posts/193431338.md': () => import('../193431338_NfhZfWHm.mjs'),
  '/src/content/posts/193580658.md': () => import('../193580658_P74-Sh7W.mjs'),
  '/src/content/posts/193615631.md': () => import('../193615631_tzJYNgGl.mjs'),
  '/src/content/posts/200629134.md': () => import('../200629134_vsQV3YCS.mjs'),
  '/src/content/posts/2019-in-media.md': () =>
    import('../2019-in-media_dpTVvFsb.mjs'),
  '/src/content/posts/2022-in-media.md': () =>
    import('../2022-in-media_SlFIblHV.mjs'),
  '/src/content/posts/207807923.md': () => import('../207807923_vxefcuNB.mjs'),
  '/src/content/posts/210271102.md': () => import('../210271102_s7mZvA7H.mjs'),
  '/src/content/posts/211267925.md': () => import('../211267925_afJ22LED.mjs'),
  '/src/content/posts/212977273.md': () => import('../212977273_9oGqigP-.mjs'),
  '/src/content/posts/219342574.md': () => import('../219342574_GIPWc9vN.mjs'),
  '/src/content/posts/233159783.md': () => import('../233159783__zb99LwU.mjs'),
  '/src/content/posts/239986466.md': () => import('../239986466_41YPWx3R.mjs'),
  '/src/content/posts/249382845.md': () => import('../249382845_btzHjB8s.mjs'),
  '/src/content/posts/251027866.md': () => import('../251027866_4LrvvSUK.mjs'),
  '/src/content/posts/279869181.md': () => import('../279869181_R0NotO7R.mjs'),
  '/src/content/posts/296971514.md': () => import('../296971514_IzU0SD1z.mjs'),
  '/src/content/posts/300794824.md': () => import('../300794824_rek7H8_i.mjs'),
  '/src/content/posts/311978752.md': () => import('../311978752_L8Qr0Gi5.mjs'),
  '/src/content/posts/331418114.md': () => import('../331418114_D6TYhUs4.mjs'),
  '/src/content/posts/339029235.md': () => import('../339029235_6gJ5NWrK.mjs'),
  '/src/content/posts/340858922.md': () => import('../340858922_RrF4AFeK.mjs'),
  '/src/content/posts/astro-rewrite.md': () =>
    import('../astro-rewrite_InwauKLt.mjs'),
  '/src/content/posts/commute.md': () => import('../commute_h4kRIqnt.mjs'),
  '/src/content/posts/dankpods-starter.md': () =>
    import('../dankpods-starter_w1q1rAY9.mjs'),
  '/src/content/posts/essential-apps.md': () =>
    import('../essential-apps_2ix-n0Ca.mjs'),
  '/src/content/posts/falsehoods-around-names.md': () =>
    import('../falsehoods-around-names_KO3XXQU0.mjs'),
  '/src/content/posts/gft-0722.md': () => import('../gft-0722_gw7eTPVK.mjs'),
  '/src/content/posts/lastfm-to-mastodon.md': () =>
    import('../lastfm-to-mastodon_-aNK3y__.mjs'),
  '/src/content/posts/lil-gator-game.md': () =>
    import('../lil-gator-game_BWO2t5gh.mjs'),
  '/src/content/posts/links-for-2023-02-16.md': () =>
    import('../links-for-2023-02-16_5JxrYsMA.mjs'),
  '/src/content/posts/links-for-2023-04-02.md': () =>
    import('../links-for-2023-04-02_AhXko6qh.mjs'),
  '/src/content/posts/links-for-2023-09-02.md': () =>
    import('../links-for-2023-09-02_OtnyHV3i.mjs'),
  '/src/content/posts/mutuals-social.md': () =>
    import('../mutuals-social_ABNMUN4z.mjs'),
  '/src/content/posts/notes-for-partner.md': () =>
    import('../notes-for-partner_hU2THr2W.mjs'),
  '/src/content/posts/omglol-shortcuts.md': () =>
    import('../omglol-shortcuts_tK8TlGgG.mjs'),
  '/src/content/posts/pride-frames.md': () =>
    import('../pride-frames_z2_ROcgJ.mjs'),
  '/src/content/posts/sf-jury-summon.md': () =>
    import('../sf-jury-summon_BC62Jiwe.mjs'),
  '/src/content/posts/tailscale-nearby-exit-nodes.md': () =>
    import('../tailscale-nearby-exit-nodes_thPAfIFl.mjs'),
  '/src/content/posts/template.md': () => import('../template_mNkqaUtB.mjs'),
  '/src/content/posts/toot-cards.md': () =>
    import('../toot-cards_Exr0kClT.mjs'),
  '/src/content/posts/uses.md': () => import('../uses_cSf8Fnz4.mjs'),
  '/src/content/posts/verify-commits.md': () =>
    import('../verify-commits_eWzsWKa1.mjs'),
  '/src/content/posts/vr-sexism.md': () => import('../vr-sexism_R6BKh1NT.mjs'),
})
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({
  '/src/content/posts/134400368.md': () => import('../134400368_JTsTyUpf.mjs'),
  '/src/content/posts/135019114.md': () => import('../135019114_zz82LSCZ.mjs'),
  '/src/content/posts/136222383.md': () => import('../136222383_Ll86LOvS.mjs'),
  '/src/content/posts/136224879.md': () => import('../136224879_S5TihzRH.mjs'),
  '/src/content/posts/136224935.md': () => import('../136224935_TF6o21-9.mjs'),
  '/src/content/posts/136763858.md': () => import('../136763858_6YnKWMpu.mjs'),
  '/src/content/posts/137009001.md': () => import('../137009001_nAorstV7.mjs'),
  '/src/content/posts/137009091.md': () => import('../137009091_6Y6m_-Ax.mjs'),
  '/src/content/posts/138288124.md': () => import('../138288124_TZubcDM5.mjs'),
  '/src/content/posts/138860938.md': () => import('../138860938_1D7JeDgP.mjs'),
  '/src/content/posts/138917375.md': () => import('../138917375_JJC0C9UA.mjs'),
  '/src/content/posts/140113304.md': () => import('../140113304_MeOC-wf0.mjs'),
  '/src/content/posts/140113399.md': () => import('../140113399_3QEcXH6r.mjs'),
  '/src/content/posts/140113823.md': () => import('../140113823_AItcg7C4.mjs'),
  '/src/content/posts/140166273.md': () => import('../140166273_kL0Sj3ij.mjs'),
  '/src/content/posts/140179091.md': () => import('../140179091_LXHPZ5K2.mjs'),
  '/src/content/posts/140733004.md': () => import('../140733004_F0aV-nsQ.mjs'),
  '/src/content/posts/141385956.md': () => import('../141385956_aCxcW8fA.mjs'),
  '/src/content/posts/143872419.md': () => import('../143872419_-ViXklx-.mjs'),
  '/src/content/posts/143963126.md': () => import('../143963126_u_s-oVKG.mjs'),
  '/src/content/posts/145124027.md': () => import('../145124027_ersfReSu.mjs'),
  '/src/content/posts/145785077.md': () => import('../145785077_KPXuSt8K.mjs'),
  '/src/content/posts/147888188.md': () => import('../147888188_iueS-x9Z.mjs'),
  '/src/content/posts/148032540.md': () => import('../148032540_ade88GoH.mjs'),
  '/src/content/posts/148553676.md': () => import('../148553676_iIBCfVu7.mjs'),
  '/src/content/posts/148553739.md': () => import('../148553739_bIhkCh0s.mjs'),
  '/src/content/posts/148896468.md': () => import('../148896468_4n_rct5E.mjs'),
  '/src/content/posts/151856049.md': () => import('../151856049_YtSH27zT.mjs'),
  '/src/content/posts/151856082.md': () => import('../151856082_q0SjGt8C.mjs'),
  '/src/content/posts/152139015.md': () => import('../152139015_kw0puzFx.mjs'),
  '/src/content/posts/152242486.md': () => import('../152242486_HCC2WJkI.mjs'),
  '/src/content/posts/164564932.md': () => import('../164564932_3_CgiuoU.mjs'),
  '/src/content/posts/164601922.md': () => import('../164601922_L2BkdfS4.mjs'),
  '/src/content/posts/170712813.md': () => import('../170712813_ZE482LMC.mjs'),
  '/src/content/posts/170712882.md': () => import('../170712882_ZeJq3OaY.mjs'),
  '/src/content/posts/170716411.md': () => import('../170716411_o2QDfEH1.mjs'),
  '/src/content/posts/173958130.md': () => import('../173958130_oSIRBg0U.mjs'),
  '/src/content/posts/175577875.md': () => import('../175577875_I48GA3rK.mjs'),
  '/src/content/posts/175926290.md': () => import('../175926290_xTldv7h8.mjs'),
  '/src/content/posts/176035092.md': () => import('../176035092_XXer6SNC.mjs'),
  '/src/content/posts/176243918.md': () => import('../176243918_hCW3pT4f.mjs'),
  '/src/content/posts/183883395.md': () => import('../183883395_Qci6_zxb.mjs'),
  '/src/content/posts/183916694.md': () => import('../183916694_3P8f9yfd.mjs'),
  '/src/content/posts/186172319.md': () => import('../186172319_2EBibgSL.mjs'),
  '/src/content/posts/187431259.md': () => import('../187431259_bMvX8Wvr.mjs'),
  '/src/content/posts/188732962.md': () => import('../188732962_ydBC3ebF.mjs'),
  '/src/content/posts/193430221.md': () => import('../193430221_P0oso8Fp.mjs'),
  '/src/content/posts/193431338.md': () => import('../193431338_Xzg1e8r9.mjs'),
  '/src/content/posts/193580658.md': () => import('../193580658_OEvExzxH.mjs'),
  '/src/content/posts/193615631.md': () => import('../193615631_sVJOd8gA.mjs'),
  '/src/content/posts/200629134.md': () => import('../200629134_FMq4KIGB.mjs'),
  '/src/content/posts/2019-in-media.md': () =>
    import('../2019-in-media_5q4VhOK8.mjs'),
  '/src/content/posts/2022-in-media.md': () =>
    import('../2022-in-media_Frs3OfaC.mjs'),
  '/src/content/posts/207807923.md': () => import('../207807923_hm4aVKZM.mjs'),
  '/src/content/posts/210271102.md': () => import('../210271102_y0Va4z7o.mjs'),
  '/src/content/posts/211267925.md': () => import('../211267925_ZBT-fmyq.mjs'),
  '/src/content/posts/212977273.md': () => import('../212977273_AmXE_ozd.mjs'),
  '/src/content/posts/219342574.md': () => import('../219342574_N0E7R3bn.mjs'),
  '/src/content/posts/233159783.md': () => import('../233159783_MmSY6Jj4.mjs'),
  '/src/content/posts/239986466.md': () => import('../239986466_oyKsFsZw.mjs'),
  '/src/content/posts/249382845.md': () => import('../249382845_YbIrT279.mjs'),
  '/src/content/posts/251027866.md': () => import('../251027866_EfqnFb-w.mjs'),
  '/src/content/posts/279869181.md': () => import('../279869181_1j0gyuPF.mjs'),
  '/src/content/posts/296971514.md': () => import('../296971514_rXdLLcrZ.mjs'),
  '/src/content/posts/300794824.md': () => import('../300794824_JtTvnnyh.mjs'),
  '/src/content/posts/311978752.md': () => import('../311978752__LVgZtQv.mjs'),
  '/src/content/posts/331418114.md': () => import('../331418114_TIBiSM7n.mjs'),
  '/src/content/posts/339029235.md': () => import('../339029235_H28S8iAH.mjs'),
  '/src/content/posts/340858922.md': () => import('../340858922_4pSlXjuj.mjs'),
  '/src/content/posts/astro-rewrite.md': () =>
    import('../astro-rewrite_QiUp308k.mjs'),
  '/src/content/posts/commute.md': () => import('../commute_TaFXrROc.mjs'),
  '/src/content/posts/dankpods-starter.md': () =>
    import('../dankpods-starter_ENniVfI4.mjs'),
  '/src/content/posts/essential-apps.md': () =>
    import('../essential-apps_ZUnmtUhx.mjs'),
  '/src/content/posts/falsehoods-around-names.md': () =>
    import('../falsehoods-around-names_-HhHLEdN.mjs'),
  '/src/content/posts/gft-0722.md': () => import('../gft-0722_69yRkKly.mjs'),
  '/src/content/posts/lastfm-to-mastodon.md': () =>
    import('../lastfm-to-mastodon_UhllMcgv.mjs'),
  '/src/content/posts/lil-gator-game.md': () =>
    import('../lil-gator-game_0-nPM0Zv.mjs'),
  '/src/content/posts/links-for-2023-02-16.md': () =>
    import('../links-for-2023-02-16_wW8JXsMs.mjs'),
  '/src/content/posts/links-for-2023-04-02.md': () =>
    import('../links-for-2023-04-02_VypyS141.mjs'),
  '/src/content/posts/links-for-2023-09-02.md': () =>
    import('../links-for-2023-09-02_MH7bK0LU.mjs'),
  '/src/content/posts/mutuals-social.md': () =>
    import('../mutuals-social_7IaUwhY9.mjs'),
  '/src/content/posts/notes-for-partner.md': () =>
    import('../notes-for-partner_14suuPy5.mjs'),
  '/src/content/posts/omglol-shortcuts.md': () =>
    import('../omglol-shortcuts_RDIC4JCj.mjs'),
  '/src/content/posts/pride-frames.md': () =>
    import('../pride-frames_p5cKLTwc.mjs'),
  '/src/content/posts/sf-jury-summon.md': () =>
    import('../sf-jury-summon_w_z35nU3.mjs'),
  '/src/content/posts/tailscale-nearby-exit-nodes.md': () =>
    import('../tailscale-nearby-exit-nodes_zFxuhwz2.mjs'),
  '/src/content/posts/template.md': () => import('../template_QsMKxmNd.mjs'),
  '/src/content/posts/toot-cards.md': () =>
    import('../toot-cards_zvNc5I4w.mjs'),
  '/src/content/posts/uses.md': () => import('../uses_f3wBXr0v.mjs'),
  '/src/content/posts/verify-commits.md': () =>
    import('../verify-commits_iyMoe40s.mjs'),
  '/src/content/posts/vr-sexism.md': () => import('../vr-sexism_8r4-ECYJ.mjs'),
})
...
const getRelatedPosts = (posts, post, limit = 2) => {
  const hasSimilarTags = t => post.data.tags.includes(t)
...
const $$PostLayout = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    const { permalink = `/p/${slug}` } = Astro2.props
    const isPostPage = `${Astro2.url}`.indexOf('/p/') > -1
    const Component = isPostPage ? $$BaseLayout : Fragment
    ...
    return renderTemplate`${renderComponent($$result, 'Component', Component, { cover: cover, description: description, permalink: permalink, title: `${title} - ${title$1}` }, { default: $$result2 => renderTemplate` ${renderComponent($$result2, 'Article', $$Article, { cover: cover, date: date, link: link, tags: tags, title: title$1, url: permalink }, { default: $$result3 => renderTemplate`${isPostPage || !wasTruncated ? renderTemplate`${renderComponent($$result3, 'Content', Content, {})}` : renderTemplate`${renderComponent($$result3, 'TruncatedContent', $$TruncatedContent, { title: title$1, url: permalink, content: truncatedMd })}`}` })} ${isPostPage && renderTemplate`${renderComponent($$result2, 'RelatedArticles', $$RelatedArticles, { posts: relatedPosts })}`}` })}`
  },
...
const $$Index = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent($$result, 'Layout', $$BaseLayout, { title: 'melkat.blog - Search', permalink: permalink, showSearch: false }, { default: $$result2 => renderTemplate` ${renderComponent($$result2, 'PageHeader', $$PageHeader, {}, { default: $$result3 => renderTemplate` ${maybeRenderHead()}<label for="search">Search</label> ` })} ${renderComponent($$result2, 'Search', $$Search, { defaultValue: query })} ${results.map(entry => entry && renderTemplate`${renderComponent($$result2, 'PostLayout', $$PostLayout, { post: entry })}`)}${noResults && renderTemplate`<p${addAttribute(cx.p, 'class')}>${'No results :('}</p>`}` })}`
  },
...
export {
  ...
  description as d,
  baseUrl as e,
  getDomainsByCount as f,
  getCollection as g,
  hasLinkNoDrafts as h,
  getAllDomains as i,
  getPostsByDomain as j,
  $$PageHeader as k,
  getTagsByCount as l,
