...
import { $ as $$Image } from './image-endpoint_a240ce1b.mjs'
...
const $$Button = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    Astro2.self = $$Button
    const cx =
      'rounded-lg bg-cerulean-600 motion-reduce:transition-none transition font-bold text-white transition-colors hover:bg-cerulean-500 active:bg-cerulean-700 text-center px-3 py-2 focus:ring-2 outline-none border border-cerulean-600 shadow-lg focus:shadow-md shadow-cerulean-500/20 focus:shadow-cerulean-500/50'
...
const $$Search = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    const cx = {
      ...
      label: 'hidden',
      input:
        'appearance-none motion-reduce:transition-none transition border-0 outline-none placeholder:text-gray-600 dark:placeholder:text-gray-400 bg-transparent ring-2 ring-cerulean-500/50 focus:ring-cerulean-500/75 rounded-lg px-3 py-2 w-full shadow-lg focus:shadow-md shadow-cerulean-500/20 focus:shadow-cerulean-500/50',
      p: 'mb-8 italic',
    }
...
const $$Footer = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${maybeRenderHead()}<footer${addAttribute(cx.footer, 'class')} role="contentinfo">${showSearch && renderTemplate`<div${addAttribute(cx.search, 'class')}>${renderComponent($$result, 'Search', $$Search, {})}</div>`}<p${addAttribute(cx.p, 'class')}>${'browse by '}<a${addAttribute(cx.a, 'class')} href="/d">links</a>${' and '}<a${addAttribute(cx.a, 'class')} href="/t">tags</a><br><a${addAttribute(cx.a, 'class')} href="/rss.xml">rss feed</a>${' \u2022 '}<a${addAttribute(cx.a, 'class')} href="/feed.json">json feed</a></p><p${addAttribute(cx.p, 'class')}>
melkat emoji by
...
const $$BaseLayout = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`<html lang="en"><head><title>${title$1}</title><meta charset="utf-8"><meta name="description"${addAttribute(description$1, 'content')}><meta name="keywords" content="melkat, blog"><meta name="viewport" content="initial-scale=1.0, width=device-width"><meta property="og:description"${addAttribute(description$1, 'content')}><meta property="og:image:height" content="630"><meta property="og:image:width" content="1200"><meta property="og:image"${addAttribute(`${baseUrl}${cover}`, 'content')}><meta property="og:title"${addAttribute(title$1, 'content')}><meta property="og:type" content="website"><meta property="og:url"${addAttribute(`${baseUrl}${permalink}`, 'content')}><link rel="alternate" type="application/feed+json"${addAttribute(title, 'title')} href="/feed.json"><link rel="alternate" type="application/rss+xml"${addAttribute(title, 'title')} href="/rss.xml"><link rel="apple-touch-icon" href="/apple-touch-icon.png"><link rel="canonical"${addAttribute(`${baseUrl}${permalink.replace(/\/1$/gi, '')}`, 'href')}><link rel="icon" href="/favicon.ico"><link rel="mask-icon" sizes="any" href="/mask-icon.svg" color="#0caceb">${renderComponent($$result, 'ViewTransitions', $$ViewTransitions, {})}${renderHead()}</head><body${addAttribute(className, 'class')}>${renderComponent($$result, 'Header', $$Header, {})}<main role="main">${renderSlot($$result, $$slots['default'])}</main>${renderComponent($$result, 'Footer', $$Footer, { showSearch: showSearch })}</body></html>`
  },
...
const $$Title = createComponent(
  async ($$result, $$props, $$slots) => {
    ...
    return renderTemplate`${renderComponent($$result, 'PageHeader', $$PageHeader, {}, { default: $$result2 => renderTemplate`${maybeRenderHead()}<a${addAttribute(link, 'href')}${addAttribute(`text-2xl md:text-3xl ${isExternal ? cxs.a : cxs.aHover}`, 'class')}${addAttribute(`${isExternal ? 'Link to ' : 'Permalink for '}${title}`, 'aria-label')}${addAttribute({ textWrap: 'balance' }, 'style')}>${title}</a>` })}`
  },
...
const renderEntryGlob = /* #__PURE__ */ Object.assign({
  '/src/content/posts/134400368.md': () => import('../134400368_9f21490f.mjs'),
  '/src/content/posts/135019114.md': () => import('../135019114_7ac33bb7.mjs'),
  '/src/content/posts/136222383.md': () => import('../136222383_ea46923f.mjs'),
  '/src/content/posts/136224879.md': () => import('../136224879_fe0ae0dd.mjs'),
  '/src/content/posts/136224935.md': () => import('../136224935_975c83ff.mjs'),
  '/src/content/posts/136763858.md': () => import('../136763858_57cb0ce1.mjs'),
  '/src/content/posts/137009001.md': () => import('../137009001_16747a3f.mjs'),
  '/src/content/posts/137009091.md': () => import('../137009091_3993dcd4.mjs'),
  '/src/content/posts/138288124.md': () => import('../138288124_4d86f224.mjs'),
  '/src/content/posts/138860938.md': () => import('../138860938_90aee0ba.mjs'),
  '/src/content/posts/138917375.md': () => import('../138917375_6491b6e7.mjs'),
  '/src/content/posts/140113304.md': () => import('../140113304_c6b336f4.mjs'),
  '/src/content/posts/140113399.md': () => import('../140113399_7352ca40.mjs'),
  '/src/content/posts/140113823.md': () => import('../140113823_89f26f8f.mjs'),
  '/src/content/posts/140166273.md': () => import('../140166273_e2afbcbd.mjs'),
  '/src/content/posts/140179091.md': () => import('../140179091_1993a69a.mjs'),
  '/src/content/posts/140733004.md': () => import('../140733004_b146b154.mjs'),
  '/src/content/posts/141385956.md': () => import('../141385956_9b423fa9.mjs'),
  '/src/content/posts/143872419.md': () => import('../143872419_497cff0b.mjs'),
  '/src/content/posts/143963126.md': () => import('../143963126_f37600a6.mjs'),
  '/src/content/posts/145124027.md': () => import('../145124027_f35fedbe.mjs'),
  '/src/content/posts/145785077.md': () => import('../145785077_8417d8c8.mjs'),
  '/src/content/posts/147888188.md': () => import('../147888188_d22ca4d6.mjs'),
  '/src/content/posts/148032540.md': () => import('../148032540_0b46021f.mjs'),
  '/src/content/posts/148553676.md': () => import('../148553676_29c5805d.mjs'),
  '/src/content/posts/148553739.md': () => import('../148553739_48756163.mjs'),
  '/src/content/posts/148896468.md': () => import('../148896468_94f43c07.mjs'),
  '/src/content/posts/151856049.md': () => import('../151856049_31324ebf.mjs'),
  '/src/content/posts/151856082.md': () => import('../151856082_ea6f4d75.mjs'),
  '/src/content/posts/152139015.md': () => import('../152139015_66a1256f.mjs'),
  '/src/content/posts/152242486.md': () => import('../152242486_8611314e.mjs'),
  '/src/content/posts/164564932.md': () => import('../164564932_500653d1.mjs'),
  '/src/content/posts/164601922.md': () => import('../164601922_e3f7aaad.mjs'),
  '/src/content/posts/170712813.md': () => import('../170712813_8a5f9f7d.mjs'),
  '/src/content/posts/170712882.md': () => import('../170712882_73a0604f.mjs'),
  '/src/content/posts/170716411.md': () => import('../170716411_6be6c41c.mjs'),
  '/src/content/posts/173958130.md': () => import('../173958130_e3c51ded.mjs'),
  '/src/content/posts/175577875.md': () => import('../175577875_4b96c666.mjs'),
  '/src/content/posts/175926290.md': () => import('../175926290_53bc4b8f.mjs'),
  '/src/content/posts/176035092.md': () => import('../176035092_3a48a0df.mjs'),
  '/src/content/posts/176243918.md': () => import('../176243918_a42bcfd4.mjs'),
  '/src/content/posts/183883395.md': () => import('../183883395_cfa792da.mjs'),
  '/src/content/posts/183916694.md': () => import('../183916694_55d7f9de.mjs'),
  '/src/content/posts/186172319.md': () => import('../186172319_72f5d7c5.mjs'),
  '/src/content/posts/187431259.md': () => import('../187431259_f1a01d0d.mjs'),
  '/src/content/posts/188732962.md': () => import('../188732962_48f2151c.mjs'),
  '/src/content/posts/193430221.md': () => import('../193430221_1ff37121.mjs'),
  '/src/content/posts/193431338.md': () => import('../193431338_e400f118.mjs'),
  '/src/content/posts/193580658.md': () => import('../193580658_1cfecfd8.mjs'),
  '/src/content/posts/193615631.md': () => import('../193615631_5918d95c.mjs'),
  '/src/content/posts/200629134.md': () => import('../200629134_3de28cfb.mjs'),
  '/src/content/posts/2019-in-media.md': () =>
    import('../2019-in-media_2328d2e7.mjs'),
  '/src/content/posts/2022-in-media.md': () =>
    import('../2022-in-media_0aea3c8a.mjs'),
  '/src/content/posts/207807923.md': () => import('../207807923_2c2bc8d7.mjs'),
  '/src/content/posts/210271102.md': () => import('../210271102_a0d51cc6.mjs'),
  '/src/content/posts/211267925.md': () => import('../211267925_7007a354.mjs'),
  '/src/content/posts/212977273.md': () => import('../212977273_28eaeb70.mjs'),
  '/src/content/posts/219342574.md': () => import('../219342574_7e000c89.mjs'),
  '/src/content/posts/233159783.md': () => import('../233159783_43cf0368.mjs'),
  '/src/content/posts/239986466.md': () => import('../239986466_8f02b9a9.mjs'),
  '/src/content/posts/249382845.md': () => import('../249382845_38fb7245.mjs'),
  '/src/content/posts/251027866.md': () => import('../251027866_6e3ab359.mjs'),
  '/src/content/posts/279869181.md': () => import('../279869181_60fe50bb.mjs'),
  '/src/content/posts/296971514.md': () => import('../296971514_84e10ef9.mjs'),
  '/src/content/posts/300794824.md': () => import('../300794824_d8b94dfa.mjs'),
  '/src/content/posts/311978752.md': () => import('../311978752_92301213.mjs'),
  '/src/content/posts/331418114.md': () => import('../331418114_64222cbb.mjs'),
  '/src/content/posts/339029235.md': () => import('../339029235_ba59a92d.mjs'),
  '/src/content/posts/340858922.md': () => import('../340858922_2b4b9521.mjs'),
  '/src/content/posts/astro-rewrite.md': () =>
    import('../astro-rewrite_8ad1572b.mjs'),
  '/src/content/posts/commute.md': () => import('../commute_5ec7cefa.mjs'),
  '/src/content/posts/dankpods-starter.md': () =>
    import('../dankpods-starter_a3ceb142.mjs'),
  '/src/content/posts/essential-apps.md': () =>
    import('../essential-apps_a26d7968.mjs'),
  '/src/content/posts/falsehoods-around-names.md': () =>
    import('../falsehoods-around-names_a638a345.mjs'),
  '/src/content/posts/gft-0722.md': () => import('../gft-0722_d04e0a0b.mjs'),
  '/src/content/posts/lastfm-to-mastodon.md': () =>
    import('../lastfm-to-mastodon_0827b45f.mjs'),
  '/src/content/posts/lil-gator-game.md': () =>
    import('../lil-gator-game_dccc91e7.mjs'),
  '/src/content/posts/links-for-2023-02-16.md': () =>
    import('../links-for-2023-02-16_e1184b10.mjs'),
  '/src/content/posts/links-for-2023-04-02.md': () =>
    import('../links-for-2023-04-02_5105448f.mjs'),
  '/src/content/posts/links-for-2023-09-02.md': () =>
    import('../links-for-2023-09-02_faae3f33.mjs'),
  '/src/content/posts/mutuals-social.md': () =>
    import('../mutuals-social_27c8368d.mjs'),
  '/src/content/posts/notes-for-partner.md': () =>
    import('../notes-for-partner_775697da.mjs'),
  '/src/content/posts/omglol-shortcuts.md': () =>
    import('../omglol-shortcuts_9bf043ed.mjs'),
  '/src/content/posts/sf-jury-summon.md': () =>
    import('../sf-jury-summon_ad27a838.mjs'),
  '/src/content/posts/template.md': () => import('../template_0c7d6143.mjs'),
  '/src/content/posts/toot-cards.md': () =>
    import('../toot-cards_9da01d4c.mjs'),
  '/src/content/posts/uses.md': () => import('../uses_0f9f7828.mjs'),
  '/src/content/posts/verify-commits.md': () =>
    import('../verify-commits_c587ccc4.mjs'),
  '/src/content/posts/vr-sexism.md': () => import('../vr-sexism_1e33b6a1.mjs'),
})
